...
metric_df_refCostAsPercentOfPropertyValue['Property refurbishment cost as % of property value'] = metric_df_refCostAsPercentOfPropertyValue['Cost']/metric_df_refCostAsPercentOfPropertyValue['Property value']*100
...
metric_df_refCostAsPercentOfPropertyValue.rename(columns={'Property refurbishment cost as % of property value':'Summed Properties Refurbishment Cost as % of Summed Properties Value'}, inplace = True)
